...
<div class="wrap">
	...
	<h1><?php _e( 'Meine Kleinanzeigen-Credits', $this->text_domain ); ?></h1>

	<form action="#" method="post">

		<h3><?php _e( 'Verfuegbare Credits', $this->text_domain ); ?></h3>
	...
	<form action="#" method="post" class="purchase_credits" >
		<h3><?php _e( 'Mehr Credits kaufen', $this->text_domain ); ?></h3>
		<table class="form-table">
			<tr>
				<th>
					<label for="purchase_credits"><?php _e('Mehr Credits kaufen', $this->text_domain ) ?></label>
				</th>
				<td>
					<p class="submit">
						<?php wp_nonce_field('verify'); ?>
						<input type="submit" class="button-secondary" name="purchase" value="<?php _e( 'Jetzt kaufen', $this->text_domain ); ?>" />
					</p>
				</td>
			</tr>
		</table>
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				...
				<span class="description"><?php _e( 'Ausgegebene Credits.', $this->text_domain ); ?></span>
				<?php else: ?>
				<span class="description"><?php _e( 'Gekaufte Credits.', $this->text_domain ); ?></span>
				<?php endif; ?>
			</td>
		</tr>
		<?php endforeach; ?>
