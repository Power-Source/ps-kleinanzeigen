...
?>
<div class="cf-empty-state cf-empty-state--b2c">
	<span>&#x1F4CB;</span>
	...
	<div class="cf-empty-cat-grid cf-empty-cat-grid--b2c">
		<?php foreach ( $_cf_empty_cats as $_cf_empty_term ) : ?>
		<a href="<?php echo esc_url( get_term_link( $_cf_empty_term ) ); ?>" class="cf-empty-cat-item cf-empty-cat-item--b2c">
