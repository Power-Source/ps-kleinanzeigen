...
?>
<div class="cf-empty-state cf-empty-state--community">
	<span>&#x1F4AC;</span>
	...
	<div class="cf-empty-cat-grid cf-empty-cat-grid--community">
		<?php foreach ( $_cf_empty_cats as $_cf_empty_term ) : ?>
		<a href="<?php echo esc_url( get_term_link( $_cf_empty_term ) ); ?>" class="cf-empty-cat-item cf-empty-cat-item--community">
